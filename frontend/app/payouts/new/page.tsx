...
interface Vendor { id: number; name: string; upi_id: string; }
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex gap-3 pt-1">
            <button
              className="flex-1 bg-blue-600 text-white py-2.5 rounded-lg text-sm font-medium disabled:opacity-50 hover:bg-blue-700 transition-colors"
              disabled={saving}
            >
            ...
            <button
              type="button"
              className="flex-1 border border-gray-300 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              onClick={() => router.back()}
            >
              Cancel
            </button>
